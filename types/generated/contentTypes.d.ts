...
export interface ApiFacilityFacility extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    desa_location: Schema.Attribute.String;
    description: Schema.Attribute.RichText;
    ...
    type: Schema.Attribute.Enumeration<
      ['Pendidikan', 'Olahraga', 'Kesehatan', 'Transportasi ', 'Ibadah']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiKknProgramKknProgram extends Struct.CollectionTypeSchema {
  collectionName: 'kkn_programs';
  info: {
    displayName: 'kkn-program';
    pluralName: 'kkn-programs';
    singularName: 'kkn-program';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProfilProfil extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visi: Schema.Attribute.RichText & Schema.Attribute.Required;
  };
}

export interface ApiResourceSectorResourceSector
  extends Struct.CollectionTypeSchema {
  collectionName: 'resource_sectors';
  info: {
    displayName: 'resource-sector';
    pluralName: 'resource-sectors';
    singularName: 'resource-sector';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    code: Schema.Attribute.Enumeration<
      ['Perikanan', 'Perkebunan', 'Pariwisata', 'Energi']
    > &
      Schema.Attribute.Required;
    color: Schema.Attribute.Enumeration<['blue', 'green ', 'orange', 'amber']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::resource-sector.resource-sector'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTourismTourism extends Struct.CollectionTypeSchema {
...
export interface ApiUmkmUmkm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Makanan', 'Minuman ', 'Kerajinan', 'Souvenir', 'Jasa', 'Lainnya ']
    >;
...
export interface ApiVillageProfileVillageProfile
  extends Struct.SingleTypeSchema {
  collectionName: 'village_profiles';
  info: {
    displayName: 'village-profile';
    pluralName: 'village-profiles';
  ...
  attributes: {
    ...
    district_name: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::village-profile.village-profile'
    > &
      Schema.Attribute.Private;
...
export interface ApiVillageVillage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    geo_type: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Desa'>;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::village-profile.village-profile': ApiVillageProfileVillageProfile;
